// src/services/mailer.js — nodemailer email helper
'use strict';
  ...
  await getTransporter().sendMail({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;background:#1a1025;color:#f0e6ff;border-radius:16px;padding:32px">
        ...
        <p>Click below to verify your email and save your progress:</p>
        ...
        <p style="color:#9b8ab0;font-size:13px">Link expires in 24 hours.</p>
        <p style="color:#9b8ab0;font-size:12px;margin-top:24px;word-break:break-all">
          Or copy: <a href="${verifyUrl}" style="color:#c77dff">${verifyUrl}</a>
        </p>
      </div>
    `,
  });
